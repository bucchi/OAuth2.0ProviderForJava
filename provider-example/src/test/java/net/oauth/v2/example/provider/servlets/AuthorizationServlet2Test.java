...
public class AuthorizationServlet2Test extends TestCase {
    ...
    public void testDoGet1() throws Exception {
        ...
        String queryParameter = "response_type=code&client_id=myKey&client_secret=mySecret&state=xyz&redirect_uri=http%3A%2F%2Flocalhost%2FCookieJar%2FCallback";
    ...
    public void testDoGet2() throws Exception {
        ...
        String queryParameter = "response_type=code&client_id=invalidKey&client_secret=mySecret&state=xyz&redirect_uri=http%3A%2F%2Flocalhost%2FCookieJar%2FCallback";
        HttpTester request = new HttpTester();
        HttpTester response = new HttpTester();
        request.setMethod("GET");
        request.setHeader("Host","server.example.com");
