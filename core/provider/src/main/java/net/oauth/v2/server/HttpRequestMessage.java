...
/**
 * An HttpServletRequest, encapsulated as an OAuth2Message.
 * 
 * @author Yutaka Obuchi
 */
public class HttpRequestMessage extends OAuth2Message {
            ...
            while (names.hasMoreElements()) {
                ...
                if (values != null) {
                    while (values.hasMoreElements()) {
                        into.add(new OAuth2.Parameter(name, values.nextElement()));
                    }
                }
            }
        }
    ...
    /* used */
    /* we need this Authorization hader may includes realm, which is ignored*/
    public static List<OAuth2.Parameter> getParameters(HttpServletRequest request) {
        ...
        for (Enumeration<String> headers = request.getHeaders("Authorization"); headers != null
            ...
            for (OAuth2.Parameter parameter : OAuth2Message
