...
/**
 * A request or response message used in the OAuth2.0 protocol.
 * <p>
...
public class OAuth2Message {
    ...
    public OAuth2Message(String method, String URL, Collection<? extends Map.Entry> parameters) {
    ...
    public OAuth2Message(String method, String URL, Collection<? extends Map.Entry> parameters,
        ...
        if (parameters == null) {
            ...
            for (Map.Entry p : parameters) {
                this.parameters.add(new OAuth2.Parameter(
    ...
    public String toString() {
        return "OAuth2Message(" + method + ", " + URL + ", " + parameters + ")";
    }
    ...
    //    addParameter(new OAuth2.Parameter(key, value));
    //}
    ...
    public String getClientId() throws IOException {
        return getParameter(OAuth2.CLIENT_ID);
    }
    ...
    public String getCode() throws IOException {
    		return getParameter(OAuth2.CODE);   
    }
    ...
    protected Map<String, String> getParameterMap() throws IOException {
        ...
        if (parameterMap == null) {
            parameterMap = OAuth2.newMap(parameters);
        }
        return parameterMap;
    }
    ...
    //        throws OAuth2ProblemException, IOException {
    ...
    //        problem.setParameter(OAuth2.Problems.OAUTH_PARAMETERS_ABSENT, OAuth2.percentEncode(absent));
    //        throw problem;
    //    }
    //}
     ...
     */
    //public void addRequiredParameters(OAuth2Accessor accessor)
    //        throws OAuth2Exception, IOException, URISyntaxException {
    //    final Map<String, String> pMap = OAuth2.newMap(parameters);
     ...
     */
    public static List<OAuth2.Parameter> decodeAuthorization(String authorization) {
        List<OAuth2.Parameter> into = new ArrayList<OAuth2.Parameter>();
            ...
            if (m.matches()) {
                ...
                into.add(new OAuth2.Parameter(AUTH_SCHEME, m.group(1)));
                    for (String nvp : m.group(2).split("\\s*,\\s*")) {
                        m = NVP.matcher(nvp);
                        if (m.matches()) {
                            String name = OAuth2.decodePercent(m.group(1));
                            String value = OAuth2.decodePercent(m.group(2));
